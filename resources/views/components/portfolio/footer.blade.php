...
<footer style="border-top:1px solid rgba(255,255,255,0.07);background:#111114;padding:2rem 3.5rem;">
    <div style="max-width:1152px;margin:0 auto;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:1rem;">
        ...
        {{-- Left --}}
        <div>
            <div style="font-family:'JetBrains Mono',monospace;font-size:13px;color:rgba(255,255,255,0.45);margin-bottom:0.35rem;">
            ...
            @if($profile && $profile->social_links)
                @foreach($profile->social_links as $social)
                    ...
                    <a href="{{ $social['url'] }}" target="_blank" rel="noopener noreferrer"
                       style="color:rgba(255,255,255,0.3);text-decoration:none;transition:color 0.2s;display:inline-flex;align-items:center;gap:5px;font-family:'JetBrains Mono',monospace;font-size:12px;"
